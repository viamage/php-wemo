...
class Bridge extends BaseDevice
{
    ...
    {
        return $this->setBulbState($deviceId, '255');
    }

    public function bulbOff($deviceId)
    {
        return $this->setBulbState($deviceId, '0');
    }

    protected function setBulbState($deviceId, $dim)
    {
        $service = $this->services['BridgeService']['serviceType'];
        $controlUrl = $this->services['BridgeService']['controlURL'];
...
available=&quot;YES&quot;&gt;'.$deviceId.'&lt;/DeviceID&gt;&lt;CapabilityID&gt;10006,10008,30008,30009,3000A&lt;/CapabilityID&gt;&lt;CapabilityValue&gt;0,'.$dim.':0,,,&lt;/CapabilityValue&gt;&lt;LastEventTimeStamp&gt;0&lt;/LastEventTimeStamp&gt;&lt;/DeviceStatus&gt;&lt;/DeviceStatusList&gt;'
        ];
